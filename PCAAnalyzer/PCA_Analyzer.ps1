...
# Define the PCA logs directory
$PcaLogPath = "C:\Windows\appcompat\pca"

# Define PCA log files
...
# ASCII Art Placeholder - Will be filled in by user
$AsciiArt = @"
    +-+-+-+ 
    |P|C|A| 
    +-+-+-+ 
...
function Export-ResultsToFormats {
    ...
    if ($AllData) {
        ...
        # Always create HTML for display
        ...
        # Return the HTML path for auto-opening
        return $HtmlPath
    } else {
...
"@
    ...
    # Create Chart.js for visualizations
    $ChartJs = @"
...
"@
    ...
    # Add Application Execution Log section
    $HtmlContent += @"
            <div class="section">
...
"@
    ...
    # Since we removed the timeline chart, we don't need to prepare that JavaScript data
    $HtmlContent += @"
    </body>
    </html>
"@
